...
function ShareElementContextProvider(_a) {
    ...
    var updateSharedElement = (0, react_1.useCallback)(function (_a, lastSeenAtPathname) {
        var id = _a.id, ref = _a.ref, animationOptions = _a.animationOptions;
        setSharedElements(function (prevSharedElements) {
            var _a;
            var lastBoundingClientRect = ref.getBoundingClientRect();
            var node = (0, utils_1.getNodeForTransition)(ref, lastBoundingClientRect);
            var animation = node.animate((0, utils_1.getKeyFrames)(prevSharedElements[id].firstBoundingClientRect, lastBoundingClientRect), __assign(__assign({}, constants_1.DEFAULT_ANIMATION_OPTIONS), animationOptions));
            if (ghostLayerRef.current) {
